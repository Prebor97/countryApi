...
public class ExchangeRateResponse{
    ...
    public ExchangeRateResponse(String result, String provider, String documentation,
                                String terms_of_use, long time_last_update_unix,
                                String time_last_update_utc, long time_next_update_unix,
                                String time_next_update_utc, long time_eol_unix,
                                String base_code, Map<String, Double> rates) {
        this.result = result;
